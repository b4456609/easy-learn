function postComment(noteId, newComment) {
  ...
  $.ajax({
    ...
    success: function() {
      console('success post new comment');
    },
  });
}
...
function getComment(NoteId, lastestCreateTime) {
  ...
  var url = 'http://140.121.197.135:11116/easylearn/comment?=' + currentNoteId;

  $.ajax({
    dataType: "json",
    url: url,
    data: lastestCreateTime,
